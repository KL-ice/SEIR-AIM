...
def main():
    ...
    out, mob_out, inf_out, true_inf, ump_out = test_lstm(len(alldates)+30, x, m0, u0, i0, control, new7, ump7, mob7, last7, new_mu, new_sigma, inf_mu, inf_sigma, ump_data[7:], mobility[6:], oxc_data, infect_rate)
    ...
    for idx in range(6):
        for i in range(len(mob_out[:, idx])):
