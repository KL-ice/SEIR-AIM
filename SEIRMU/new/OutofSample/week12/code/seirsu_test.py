...
parser.add_argument('--iternum', nargs='+', type=int, default=[20, 20, 20, 20], help='ump, seir, mob, inf')
...
if_all = '_all' if args.iternum[2] >=21 else ''
...
if_all = '_all' if args.iternum[3] >=21 else ''
