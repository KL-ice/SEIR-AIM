...
def train_all():
    ...
    for train_iter in range(10):
        ...
        #     ump_optim = optim.Adam([{'params':ump_net.parameters(), 'lr': 1e-5, 'weight_decay': 5e-5}])
        # else:
        ...
        #         opt = optim.Adam([{'params':mod.parameters(), 'lr': 5e-5, 'weight_decay': 5e-5}])
        #     else:
        ...
        for i in range(5):
            _mob_data = _mob_data + _mob_data[-20:]
            infect_rate = infect_rate + infect_rate[-20:]
