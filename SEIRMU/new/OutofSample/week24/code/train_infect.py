...
def paint_inf_pred(data, control, model):
    ...
    paint(infs, data['inf'][:len(infs)], 'inf')
...
def train_inf(model, optimizer, data, control, train_iter):
    ...
    # TODO: check
    inf_loss_weight = list(copy.deepcopy(loss_weight))
    inf_loss_weight = inf_loss_weight + inf_loss_weight[-14:] + inf_loss_weight[-14:] + inf_loss_weight[-14:] + inf_loss_weight[-3:] + inf_loss_weight[-3:] + inf_loss_weight[-3:] + inf_loss_weight[-3:] + inf_loss_weight[-3:] + inf_loss_weight[-3:]
    train_data, test_data = split_train_set(data, inf_loss_weight)
