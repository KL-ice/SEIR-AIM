...
def train_all():
    ...
    for train_iter in range(51, 60):
        ...
        _mob_data = _mob_data + _mob_data[-14:] + _mob_data[-14:] + _mob_data[-14:] + _mob_data[-3:] + _mob_data[-3:] + _mob_data[-3:] + _mob_data[-3:] + _mob_data[-3:] + _mob_data[-3:]
        infect_rate = infect_rate + infect_rate[-14:] + infect_rate[-14:] + infect_rate[-14:] + infect_rate[-3:] + infect_rate[-3:] + infect_rate[-3:] + infect_rate[-3:] + infect_rate[-3:] + infect_rate[-3:]
