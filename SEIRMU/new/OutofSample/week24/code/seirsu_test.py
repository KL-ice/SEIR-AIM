...
parser.add_argument('--iternum', nargs='+', type=int, default=[54, 54, 54, 54], help='ump, seir, mob, inf')
...
def main():
    ...
    oxc_data = read_oxc_onehot(end_date='2021-04-02')
    print(len(oxc_data))
    ...
    print(len(true_inf), len(infect_rate))
    print(true_inf)
    for i in range(len(infect_rate)):
        infect_rate[i] = infect_rate[i] * (inf_sigma - inf_mu) + inf_mu 
    print(infect_rate)
